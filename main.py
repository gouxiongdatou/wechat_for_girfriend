...
def get_eatmorning_words():
    list=[
            ...
            "我们都得经历一段努力、闭嘴、不抱怨的时光，才能熠熠生辉，才能去更酷的地方，成为更酷的人。早安！宝贝",
            "人们常说一年之计在于春，一天之计在于晨，可以说早餐的重要。",
            "生活本来就是一场恶战，给止疼药也好，给巴掌也罢，最终都是要单枪匹马练就自身胆量，谁也不例外。早安！宝贝",
            "晒晒我家的早餐，15分钟上桌，简单快捷，花钱少，吃得舒服。",
            "美好的一天从早上开始，当然美丽的心情从早餐开始，别忘了吃早餐哦。",
            "别将过去抱的太紧，因为那样你就腾不出手来拥抱此刻了！早上好！宝贝",
            "想吃一顿休闲早餐，像城市的女士们一样优雅地喝一杯美国咖啡，安静地坐着，享受秋天的阳光。",
            "充满了精神的青春，是不会那么轻易消失的。早安！宝贝",
            ...
            "幸福如甜品，但酸甜苦辣的人生才是正餐。",
            "愿你沉淀又执着，对每件热爱的事物，都全力以赴又满载而归，变成一个美好的人，做美好的事。早安！宝贝",
            "是谁来自山川湖海，却囿于昼夜，厨房与爱。",
            "元气早餐秋冬天气，宜多喝汤水，粥类，预防上火。",
            "连起床这么艰难的事你都做到了，接下来的一天还有什么能难倒你！加油！早安哦！宝贝",
            "吃食是一种幸福，品味是一种情趣。",
            ...
            "我们单枪匹马闯入这世间，只为活出属于自己的所有可能；愿你这一生既有随处可栖的江湖，也有追风逐梦的骁勇。早安！宝贝",
            "有足够的时间做一顿有仪式感的早餐也是一种享受。",
            "心情好时，就算是阴天也会感觉到阳光的存在。",
            "世界那么大，我们去吃吃看？",
            "生活本来就是平凡琐碎的，哪有那么多惊天动地的大事，快乐的秘诀就是不管对大事小事都要保持热情。早安！宝贝",
...
def get_eatnoon_words():
    list = [
            "人生是自己的，不要活在别人的眼神和口水里。不是所有的言论都需要别人理解，不是所有的选择都需要别人支持。午安。宝贝",
            "中午好，宝贝，最好的祝福送给你！祝你幸福快乐！事事顺利！",
            "友情，在时间的隧道里发酵；情谊，在时光的长河里升华；思念，在彼此的世界里徘徊；问候，则在真挚的呼唤中出炉。宝贝，无论何时何地，都愿你天天开心，幸福每时每刻！",
            "培养自己承担责任的勇气和自信心的训练，那么无疑会使一个胆怯懦弱的人以令人惊讶的速度成长为一个坚强勇敢的人。中午好！宝贝",
            
            "在一个秋高气爽的下午，躺在树荫下，泡一壶清茶。抱着自己喜欢的书慢慢品味这美好的生活。中午好！宝贝",
            "睁开眼睛，给你一个轻轻的祝福，愿它每分每秒都带给你健康好运和幸福。",
            "中午好宝贝，醉人甜歌问候送给你，衷心祝福宝贝中午开心快乐。",
            "当你收到信息时，那是我的心声；当你感觉温暖时，那是我的欣慰，当你会心一笑时，那是我的期盼；你快乐幸福每一天，是我的心愿。",
            "最好的生活是：时光，浓淡相宜;人心，远近相安。午安。宝贝",
            "真切的祝福你，我的宝贝，生活虽然平淡，但却天天开心！早上醒来笑一笑，中午睡个美容觉，晚上烦恼都跑掉，明天生活会更好，幸福永远将你怀抱！",
            "永远不要对任何事感到后悔，因为它曾经一度就是你想要的。后悔也没用，要么忘记，要么努力。",
            "不要为了迎合所有人，把自己过得那么累!费尽心思让所有人都开心，你会忘了自己该怎么笑!午安!宝贝",
            "把每个睡醒后的早晨当成一件礼物，把每个开心后的微笑当成一个习惯。宝贝，中午好，愿你微笑今天，快乐永远！中午好！宝贝",
            "如果我的祝愿，能驱除你的烦恼，那么，就让它随这温馨的春风，吹进你的心谷吧！",
            "疲惫的时候我的肩膀是你温馨的港湾，失败的时候我的鼓励是你力量的源泉，伤心的时候我的祝福为你衷心祈愿，宝贝，我永远在你的身边，永远祝福你！",
            "激励自我，让斗志昂扬，鼓舞自我，让信心坚挺，完善自我，让能力发挥，努力自我，让梦想实现，拼搏自我，让生活幸福，超越自我，让未来精彩！",
            "夏日养生多喝茶，清心利尿效果佳，解热除烦真不差，止渴消暑好方法，热茶降温笑哈哈，各种冷饮不如它，祝你夏季笑哈哈，注意身边要有茶！中午好！宝贝",
            "把每个睡醒后的早晨当成一件礼物，把每个开心后的微笑当成一个习惯。宝贝，短信祝早上好，愿你微笑今天，快乐永远！",
            "在男人的世界里，只有更稳定，才出众。只有不走寻常路，张开理想的翅膀飞越无限，才是我们我们正在努力的方向。",
           
            "微笑，可以融化沉重的脸。欣赏，可以鼓舞沮丧心田。帮助，可以减轻人生重担。分享，可以激励奋发潜力。我们每天快乐一点点，生活就会精彩一点点！",
            "生活像一架跷跷板，一头是脾气，一头是福气，脾气越大福气越少，脾气越小福气越大。收得住脾气，才能留得住福气。午安。宝贝",
         
            "以前总怕别人不喜欢自己，于是拼命迎合讨好，要是被误会了就恨不得马上能解释能化解。现在越长大心越大，不喜欢就不喜欢呗，大路朝天，各走一边。",
           
            "两人就这么消磨一下午的时光，相对而言，风平浪静，背后各是一生的波涛诡谲，不可说。中午好！宝贝",
            "自己能做的事情，不要去麻烦别人。中午好！宝贝","生活处处有困难，个子高的老撞头，个子矮的惹人笑，有钱的招红眼，没钱的招冷眼，我一正常年轻帅小伙，什么挫折不能过。",
            ...
            "真情，把距离拉近；真诚，把心灵吸引；真爱，把祝福传达；珍惜，把情意绵延。祝朋友健健康康，平平安安，幸幸福福，快快乐乐！中午好！宝贝",
            "中午好，别清闲着，现发放些工作给你，一定要按时完成，把快乐文件整理好，把幸福资料准备全，把欢乐证明做出来，好吧开始工作吧！",
           
            "女孩，如果你选择了放弃，就不要抱怨。因为世界是平衡的，每个人都要通过自己的努力去决定生活的样子。没人扶你的时候，自己要站直，路还长，背影要美。中午好！宝贝",
            "人生有多残酷，你就该有多坚强，别让挫折带走你的微笑和最初的梦想。",
            "初春时光，乍暖还寒，我的问候温暖不变；初春时节，阴晴不定，我的关怀始终不变；初春时分，万物新生，我的祝福与日俱增！祝好友万事俱备，不欠东风！中午好！宝贝",
            "经我反复协商，你的幸福专栏已搞定！你的财富，由财神独家赞助；你的笑容，由蒙娜丽莎代为发布；你的痛苦，引流到壶口瀑布；你的幸福，小心众人嫉妒！中午好！宝贝",
            ...
            "生活，忙忙碌碌；身影，急急匆匆；牵挂，点点滴滴；思念，真真切切；问候，甜甜蜜蜜；祝福，真真挚挚。祝你每天快快乐乐，一生幸幸福福。中午好！宝贝",
            "天气渐渐变凉，衣衫应该多加，出来晒晒太阳，让我给你温暖，脸上带着微笑，幸福心中荡漾。愿你工作顺利，心情开朗，工资多加！中午好！宝贝",
            "中午好，最真诚的祝福送给你，祝你幸福快乐，幸福因为有你。","送你一朵玫瑰，那是我心中惟一一朵。只有戴在你的胸前，它才不会枯萎。",
            "心静者高，高者俯瞰世界;心和者仁，仁者包容万物;心慈者深，深者淡对冷暖;心慧者安，安者笑对人生。午安，宝贝。",
           
            "最大的敌人莫过于自己，最大的缺点莫过于知错未改，谁都不是生下来就是天才，成功就要战胜自己，跨过坎坷。",
            "有压力，但不要被压垮；有迷茫，但永不要绝望。勇敢地去追求梦想，大胆地去创造奇迹。快乐与幸福只属于拼搏的你。愿成功与你如影相随！",
            "男人和成熟男人对女人的区别就是，前者哄你上床，后者哄你睡觉，宝贝午安。",
            "人生无限事，少有随心意，不可就此悲人生，就叹前路惘。笑看人生事，乐怀挫折事，人生丰富百媚生，成功指日创。",
            "让我的友情变成你的影子，陪伴你寂寞的光荫。让我的祝福变成雄心，鼓励你走过艰难困境。生活没有一帆风顺，努力就是成功！",
            "这个夏天，真心祝愿：大树庇护你，烈日让着你，微风向着你，暴雨躲着你，爱人由着你，邻居帮着你，朋友记着你，中奖万的只有你。中午好！宝贝",
            
            "做有用的事，说勇敢的话，想美好的事，睡安稳的觉，把时间用在进步上，而不是抱怨上。愿你遇到这样的人，愿你成为这样的人。午安。宝贝",
            "褪去疲劳，忘却烦躁，放眼今天，无限美好。好朋友的祝福总是很早，愿你每天微笑，心情大好，祝你健康幸福，万事顺意，中午好！宝贝",
            "把脸迎向微风，就能感受凉爽；把脸迎向阳光，就能感受温暖；把人生面向春天，就会充满动力。即使是冬日，也要像向日葵一样绽放，像夏日一样明媚。",
            "枫叶，证明秋天的存在；金菊，证明秋天的美丽；秋水，证明秋天的多情；秋月，证明秋天的浪漫；短信，证明我的思念；你，证明笨蛋是有的；哈哈！中午好！宝贝",
            "一次的想念，两次的失眠，三次的茶饭不思，四次的整夜不眠，五次的天天祝愿，六次的心语心愿，七次幻化成万言归一话，宝贝，想你了，祝你好运，中午好！宝贝",
          
            "早晨推开窗，拥抱阳光，觉得天然的浅笑；夜晚散漫步，聊聊家常，品尝普通的愉悦。中午好！愿你一天愉悦美妙！中午好！宝贝",
            "晚上，对着孤灯，我陷入不可名状的思念之中，实在排解不开时，我排徊在我俩散步的海滩、草地，对着星星、月亮，声声呼唤着你!",
            "苦辣酸甜，百味人生。较真起来，谁都难免觉得自己不够富足，但仔细想想，你拥有的其实并不少。学会感恩、知足常乐，方能获得幸福的生活。午安，宝贝。",
            ...
            "人生道路上的每一个里程碑，都刻着两个字起点。中午好！宝贝",
            "天冷了，大树发抖了小草打冷颤了，小白兔穿羽绒服了，蚂蚁买了暧水袋了，小强冬眠了。中午了，你还看什么？多穿一件衣服，午睡别感冒了！",
            "不管忙不忙碌，有牵挂就好，不管联不联系，能想起就好，祝福总是相互的，不管身在何处，照顾好自我就是给对方最大的安慰，愿你的工资天天上升，情绪时时开心，中午好。宝贝",
            "没摘到春天的花朵，一样拥有春天。中午好！宝贝"
            ]
...
def get_goodnight_words():
   list=[
     ...
     "当鸟儿倦了的时候，它会选择飞回巢穴，当人儿累的时候，他会选择回到家里，卸去疲惫的伪装，放松自己心情，原来生活是这样的美好，晚安，宝贝！",
     "烦恼再多，工作再累，也要休息，安心睡觉，养足精神，充足睡眠，健康生活，活力四射，才能快乐每一天，夜深了，快安心休息吧、",
    
     "把酒言欢的时候，你是否还在拼搏，秋风送爽的时候，你是否还在加班，我的关心，才最珍贵，今夜我还在想着你入睡，宝贝，晚安！",
     "原来，看不见的伤痕最疼，流不出的眼泪最冷、","人生的路，总有几道沟坎；生活的味，总有几分苦涩、重要的是懂得调解。晚安！宝贝",
     "有些事，无能为力，就顺其自然；有些人，不能强求，就一笑了之；有些路，躲避不开，就义无反顾。晚安！宝贝",
